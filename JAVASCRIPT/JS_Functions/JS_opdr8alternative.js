...
// function grading() {
//     // console.log(element);
//     gradeNum = document.getElementById("ww").value;
//    console.log(gradeNum);
//     if (gradeNum <= 5.5) {
//         document.getElementById("ww").style.background = "#ff6666";
//     } else if (gradeNum >= 5.6 && gradeNum <= 7.5) {
//         document.getElementById("ww").style.background = "#6B5";
//     } else if (gradeNum >= 7.6) {
//         document.getElementById("ww").style.background = "#556B2F";
//     }

// }
grading(document.getElementById("ww"));
grading(document.getElementById("wj"));
grading(document.getElementById("wk"));
grading(document.getElementById("ws"));
grading(document.getElementById("wjo"));
grading(document.getElementById("wg"));
